...
let leastLoyal = [];
let mostLoyal = [];
let leastLoyalSenate = document.getElementById("senate-least-loyal");
let mostLoyalSenate = document.getElementById("senate-most-loyal");
...
function printLeastLoyal() {
  for (let i = 0; i < leastLoyal.length; i++) {
    ...
    leastLoyalSenate.appendChild(newTr);
  }
}
...
function printMostLoyal() {
  for (let i = 0; i < mostLoyal.length; i++) {
    ...
    mostLoyalSenate.appendChild(newTr);
  }
}